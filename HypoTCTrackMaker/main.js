var HypoTrack = (function(){
    ...
    const WIDTH = 1600;
    const HEIGHT = 800;
    const COLORS = ['#5ebaff','#00faf4','#c4ffff','#efef80','#ffc335','#f18f10','#ff683a','#ff476a','#de1855','#c80d34','#bf0c70','#b732ef','#d323d6','#ff3a9e','#c0c0c0']; // test
    const COLORS_LEGACY = ['#009DFF','#07FF0C','#BCFF83','#FFFF00','#FFB600','#FF6E07','#FF2600','#FF0055','#8B0000','#CC0033','#CB10FF','#00A859','#06FFF2','#A8A8A8','#FFFFFF'];
